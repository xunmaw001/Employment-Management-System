...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"width":"100%","padding":"10px","alignItems":"center","flexWrap":"wrap","display":"flex","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"5px 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>文化程度</div>
        <el-input v-model="formSearch.wenhuachengdu" placeholder="文化程度" clearable></el-input>
      </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.wenhuachengdu != '') searchWhere.wenhuachengdu = '%' + this.formSearch.wenhuachengdu + '%';
