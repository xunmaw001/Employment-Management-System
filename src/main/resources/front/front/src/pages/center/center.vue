    ...
    <el-tabs tab-position="left" :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.302)","background":"#baebe8"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="学生账号" prop="xueshengzhanghao">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="籍贯" prop="jiguan">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="文化程度" prop="wenhuachengdu">
            <el-input v-model="sessionForm.wenhuachengdu" placeholder="文化程度" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="联系方式" prop="lianxifangshi">
            <el-input v-model="sessionForm.lianxifangshi" placeholder="联系方式" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='xuesheng'" label="身份证" prop="shenfenzheng">
            <el-input v-model="sessionForm.shenfenzheng" placeholder="身份证" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="企业账号" prop="qiyezhanghao">
            <el-input v-model="sessionForm.qiyezhanghao" placeholder="企业账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="企业名称" prop="qiyemingcheng">
            <el-input v-model="sessionForm.qiyemingcheng" placeholder="企业名称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="企业类型" prop="qiyeleixing">
            <el-input v-model="sessionForm.qiyeleixing" placeholder="企业类型" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="企业邮箱" prop="qiyeyouxiang">
            <el-input v-model="sessionForm.qiyeyouxiang" placeholder="企业邮箱" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="企业地址" prop="qiyedizhi">
            <el-input v-model="sessionForm.qiyedizhi" placeholder="企业地址" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="企业介绍" prop="qiyejieshao">
            <el-input v-model="sessionForm.qiyejieshao" placeholder="企业介绍" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='qiye'" label="图片">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="qiyetupianHandleAvatarSuccess">
              <img :style='{"border":"2px dashed #01AE9D","cursor":"pointer","color":"#01AE9D","borderRadius":"6px","textAlign":"center","width":"80px","fontSize":"32px","lineHeight":"80px","height":"80px"}' v-if="sessionForm.tupian" :src="baseUrl + sessionForm.tupian" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.sessionForm, 'wenhuachengdu', null);
      }
      if ('xuesheng' == this.userTableName) {
      ...
      if ('qiye' == this.userTableName) {
        this.$set(this.sessionForm, 'qiyeleixing', null);
      }
      if ('qiye' == this.userTableName) {
    ...
    methods: {
      ...
      qiyetupianHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('qiye' == this.userTableName) {
