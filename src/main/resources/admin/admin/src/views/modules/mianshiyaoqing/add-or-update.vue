<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="面试标题" prop="mianshibiaoti">
					<el-input v-model="ruleForm.mianshibiaoti" placeholder="面试标题" clearable  :readonly="ro.mianshibiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="面试标题" prop="mianshibiaoti">
					<el-input v-model="ruleForm.mianshibiaoti" placeholder="面试标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="面试内容" prop="mianshineirong">
					<el-input v-model="ruleForm.mianshineirong" placeholder="面试内容" clearable  :readonly="ro.mianshineirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="面试内容" prop="mianshineirong">
					<el-input v-model="ruleForm.mianshineirong" placeholder="面试内容" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.qiyefengmian" label="企业封面" prop="qiyefengmian">
					<file-upload
						tip="点击上传企业封面"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.qiyefengmian" label="企业封面" prop="qiyefengmian">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.qiyefengmian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
			</template>
