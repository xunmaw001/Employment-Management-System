	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="标题类型" prop="biaotileixing">
					<el-input v-model="ruleForm.biaotileixing" placeholder="标题类型" clearable  :readonly="ro.biaotileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="标题类型" prop="biaotileixing">
					<el-input v-model="ruleForm.biaotileixing" placeholder="标题类型" readonly></el-input>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xinwenneirong = this.ruleForm.xinwenneirong.replace(reg,'../../../springbootw3209/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhaopinxinwen/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhaopinxinwenCrossAddOrUpdateFlag = false;
						 this.parent.search();
