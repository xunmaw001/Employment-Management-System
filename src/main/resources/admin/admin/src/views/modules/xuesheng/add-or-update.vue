	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="文化程度" prop="wenhuachengdu">
					<el-input v-model="ruleForm.wenhuachengdu" placeholder="文化程度" clearable  :readonly="ro.wenhuachengdu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="文化程度" prop="wenhuachengdu">
					<el-input v-model="ruleForm.wenhuachengdu" placeholder="文化程度" readonly></el-input>
				</el-form-item>
