<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="咨询标题" prop="zixunbiaoti">
					<el-input v-model="ruleForm.zixunbiaoti" placeholder="咨询标题" clearable  :readonly="ro.zixunbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="咨询标题" prop="zixunbiaoti">
					<el-input v-model="ruleForm.zixunbiaoti" placeholder="咨询标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="咨询内容" prop="zixunneirong">
					<el-input v-model="ruleForm.zixunneirong" placeholder="咨询内容" clearable  :readonly="ro.zixunneirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="咨询内容" prop="zixunneirong">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="咨询时间" prop="zixunshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zixunshijian" label="咨询时间" prop="zixunshijian">
